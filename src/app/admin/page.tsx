...
export default async function AdminDashboardPage() {
  const [chiffreAffaires, nombreCommandes, produitsActifs, dernieresCommandes, ventesParMois, topProduits] =
    await Promise.all([
  ...
  return (
    <div>
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <div className="carte-3d p-4">
          <p className="text-xs text-encre/40">Produits actifs</p>
          <p className="mt-1 text-2xl font-semibold text-encre">{produitsActifs}</p>
        </div>
      </div>

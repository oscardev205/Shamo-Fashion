...
export async function generateMetadata({
  ...
  if (recherche) {
    return { title: `Résultats pour "${recherche}"`, description: `Produits Shamo Fashion correspondant à "${recherche}".` };
  }
  if (categorie) {
    ...
    if (cat) {
      return {
        title: cat.nom,
        description: `Découvrez notre sélection de ${cat.nom.toLowerCase()}, chez Shamo Fashion.`,
      };
    }
  }
  ...
  return {
    title: "Boutique",
    description: "Costumes, chemises, chaussures, montres et accessoires haut de gamme — toute la boutique Shamo Fashion.",
  };
}

    ...
    <header className="sticky top-0 z-20 border-b border-sable bg-papier/95 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          {/* Dépose le fichier du logo dans /public/logo-shamo.png (fond transparent
              de préférence) — il s'affichera ici automatiquement, rien d'autre à changer. */}
          <Link href="/" className="flex items-center">
            <Image src="/logo-shamo.png" alt="Grace Débordée — Shamo Fashion" width={160} height={50} className="h-10 w-auto sm:h-11" priority />
          </Link>
        </div>
